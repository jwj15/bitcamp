...
<div class='col-sm-10'>
<input class='form-control' id='email' type='email' name='email' value='<%=member.getEmail()%>'>
</div>
</div>
<div class='form-group row'>
...
<div class='form-group row'>
<label class='col-sm-2 col-form-label' for='date'>등록날짜</label>
<div class='col-sm-10'>
<input class='form-control' readonly id='date' type='text' value='<%=member.getCreatedDate()%>'>
</div>
</div>
<div class='form-group row'>
<div class='col-sm-10'>
