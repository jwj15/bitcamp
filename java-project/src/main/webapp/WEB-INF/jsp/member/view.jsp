...
<div class='col-sm-10'>
<input class='form-control' id='email' type='email' name='email' value='${member.email}'>
</div>
</div>
<div class='form-group row'>
...
<div class='col-sm-10'>
<input class='form-control' readonly id='date' type='text' value='${member.createdDate}'>
</div>
</div>
<div class='form-group row'>
<div class='col-sm-10'>
