...
원래는 Java 뿐만 아니라 다른 프로그래밍 언어도 수요하려 하였다.<br>
즉, JSP를 Java에 종속된 기술이 아니라 언어에 독립된 기술로 만들려 하였다.<br>
그러나 지금까지 Java만 지원하고 있다.<br>
한 때 개발자들이 Java 이외에 언어도 지원하도록 오픈프로젝트를 진행한 적이 있다.<br>
그러나 지금은 모두 폐기되었다.<br>
현재는 'java'값만 지정할 수 있다.<br>
</p>

<h3> contenetType 속성</h3>
<p>
...
<pre class='java'>
    // contentType="text/html;charset=UTF-8"
    response.setContentType("contenetyType 속성에 들어있는 값");
</pre>

<h3> pageEncoding 속성</h3>
<p>
JSP 페이지를 작성할 때 사용한 문자집합을 지정한다.<br>
JSP 엔진이 템플릿 데이터를 출력문으로 바꿀 떄 참조한다.<br>
...
<h3>autoFlush 속성</h3>
<p>
출력한 콘텐츠가 버퍼에 꽉 찼을 때 자동으로 출력할지를 결정한다.<br>
...
콘텐츠의 클라이언트로 보낼 페이지의 콘텐츠 양이 크고, 한번에 보내고 싶다면
버퍼의 크기를 증가시켜라!<br>
</p>
