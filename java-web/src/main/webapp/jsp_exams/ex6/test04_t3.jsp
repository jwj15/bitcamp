...
<body>
<h1>jsp:getProperty 테스트</h1>
<p>겟터 호출하기.<br>
setProperty를 사용하는 경우 new 명령을 사용하여 객체를 만든 후<br>
그 객체를 PageContext에 담아놓고, setProperty를 사용해도 문제가 없는데,<br>
...
그러니 가능한 useBean으로 객체를 만든 후 이 태그를 사용하라!
</p>
...
재직: <jsp:getProperty name="m" property="working" /><br>
</p>
</body>
</html>
