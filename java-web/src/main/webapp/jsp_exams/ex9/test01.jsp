...
<pre>
1. Core
  - 태그라이브러리 이름 : "http://java.sum.com/jsp/jstl/core"
  - 주로 사용하는 별명 : "c"
2. XML
  - 태그라이브러리 이름 : "http://java.sum.com/jsp/jstl/xml"
  - 주로 사용하는 별명 : "x"
3. I18N
  - 태그라이브러리 이름 : "http://java.sum.com/jsp/jstl/fmt"
  - 주로 사용하는 별명 : "fmt"
4. Database
  - 태그라이브러리 이름 : "http://java.sum.com/jsp/jstl/sql"
  - 주로 사용하는 별명 : "sql"
5. Functions
  - 태그라이브러리 이름 : "http://java.sum.com/jsp/jstl/functions"
  - 주로 사용하는 별명 : "fn"
...
<h2>용어</h2>
<h3>I18N</h3> 
<p>Internationalization의 약자이다.<br>
프로그램을 개발할 때 다국어를 지원할 것을 대비해 개발하는 것을 말한다.
