...
public class Test07 {
    ...
    public String m1(Model model) {
        ...
        // Model 에 보관된 값이 ServletRequest에 저장되었는지 확인해보자
    ...
    // 세션에 있는 값을 @SessionAttributes에서 지정한 값을
    // ServletRe 보관소에 복사해준다.
    // => 다만 이미 SErvletRequest에 그 이름을 갖는 값이 있다면, 그 값을 그대로 둔다.
    @RequestMapping(value="/m5")
    public String m5() {
        
        // 여기에서 Model 객체에 name과 age 값을 저장하지 않더라도,
        // (즉 ServletRequest에 name과 age가 없다)
        // 세션에 보관된 값중에서 @SessionAttributes에 지정된 값은 
        // JSP를 실행하기 전에 
        // 
        return "v03/test07/m1";
    }
